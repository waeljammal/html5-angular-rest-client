 ...
 *      Contact:
 *      <ul>
 *        <li ng-repeat="contact in settings.skills">
 ...
 *      this.skills.push({type: 'email', value: 'yourname@example.org'});
 *    };
 *
 *    SettingsController1.prototype.removeContact = function(contactToRemove) {
 *     var index = this.skills.indexOf(contactToRemove);
 ...
 *
 *       var firstRepeat =
 *           container.element(by.repeater('contact in settings.skills').row(0));
 *       var secondRepeat =
 *           container.element(by.repeater('contact in settings.skills').row(1));
 *
 ...
 *
 *       expect(container.element(by.repeater('contact in settings.skills').row(2))
 ...
 *     Contact:
 *     <ul>
 *       <li ng-repeat="contact in skills">
 *         <select ng-model="contact.type">
 *            <option>phone</option>
 *            <option>email</option>
 *         </select>
 ...
 *       $scope.skills.push({type:'email', value:'yourname@example.org'});
 *     };
 *
 *     $scope.removeContact = function(contactToRemove) {
 *       var index = $scope.skills.indexOf(contactToRemove);
 ...
 *
 *      var firstRepeat =
 *          container.element(by.repeater('contact in skills').row(0));
 *      var secondRepeat =
 *          container.element(by.repeater('contact in skills').row(1));
 *
 *      expect(firstRepeat.element(by.model('contact.value')).getAttribute('value'))
 *          .toBe('408 555 1212');
 *      expect(secondRepeat.element(by.model('contact.value')).getAttribute('value'))
 ...
 *      container.element(by.linkText('add')).click();
 *
 *      expect(container.element(by.repeater('contact in skills').row(2))
 *          .element(by.model('contact.value'))
 *          .getAttribute('value'))
 *          .toBe('yourname@example.org');
 *    });
